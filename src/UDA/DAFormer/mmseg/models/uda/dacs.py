...
class DACS(UDADecorator):
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg, target_img, target_img_metas):
        ...
        mix_losses = self.get_model().forward_train(mixed_img, img_metas, mixed_lbl, pseudo_weight, return_feat=True)
        ...
        if self.local_iter % self.debug_img_interval == 0:
            ...
            for j in range(batch_size):
                ...
                #     subplotimg(axs[1][4], self.debug_gt_rescale[j], 'Scaled GT', cmap='oem')
                for ax in axs.flat:
                    ax.axis('off')
