...
data = dict(
    ...
    train=dict(
        ...
        source=dict(# source train set
            ...
            split = "uda_splits/train_pseudo_france_usa_source.txt", 
...
#         img_dir="rgb_images",  
#         ann_dir="pseudo_real_labels", 
#         split = "uda_splits/train_pseudo_france_usa_source_v2.txt", 
#         pipeline=source_train_pipeline),
#     val=dict(# val set
#         type=dataset_type,
#         data_root=data_root,
#         img_dir="rgb_images",  
#         ann_dir="pseudo_real_labels", 
#         split = "uda_splits/val_pseudo_france_usa_source.txt", 
#         pipeline=test_pipeline),
#     test=dict(# target test set
#         type=dataset_type,
#         data_root=data_root,
