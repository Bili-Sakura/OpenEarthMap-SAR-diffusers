...
img_norm_cfg = dict(
    mean=[123.0489, 126.8835, 113.9639], std=[56.9896, 48.3336, 46.5853], to_rgb=True)  
# img_norm_cfg = dict(mean=[46.2651], std=[3.4281], to_rgb=False) 
crop_size = (512, 512)
...
data = dict(
    ...
    train=dict(
        ...
        source=dict(# source train set
            ...
            split = "uda_splits/train_pseudo_france_source.txt", 
        ...
        target=dict(# target train set
            ...
            img_dir="rgb_images",  
            ann_dir="pseudo_real_labels", 
            split = "uda_splits/train_pseudo_japan_target.txt", 
    ...
    val=dict(# target val set
        ...
        img_dir="rgb_images",  
        ann_dir="pseudo_real_labels", 
        split = "uda_splits/val_pseudo_japan_target.txt", 
    ...
    test=dict(# target test set
        ...
        img_dir="rgb_images",  
        ann_dir="real_labels", 
        # split = "uda_splits/test_real_japan_target.txt", 
        split = "uda_splits/test_real_france_target.txt", 
        pipeline=test_pipeline)
)
...
#         img_dir="rgb_images",  
#         ann_dir="pseudo_real_labels", 
#         split = "uda_splits/train_pseudo_france_source_v2.txt", 
#         pipeline=source_train_pipeline),
#     val=dict(# val set
#         type=dataset_type,
#         data_root=data_root,
#         img_dir="rgb_images",  
#         ann_dir="pseudo_real_labels", 
#         split = "uda_splits/val_pseudo_france_source.txt", 
#         pipeline=test_pipeline),
#     test=dict(# target test set
#         type=dataset_type,
#         data_root=data_root,
