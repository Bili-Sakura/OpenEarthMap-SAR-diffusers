...
def main(args):
    ...
    if args.work_dir is not None:
        ...
        cfg.work_dir = osp.join('./work_dirs/rgb_pseudo_4123_real_210', osp.splitext(osp.basename(args.config))[0])
        # cfg.work_dir = osp.join('./work_dirs/sar_pseudo_4123_real_210_oracle', osp.splitext(osp.basename(args.config))[0])
        # cfg.work_dir = osp.join('./work_dirs/sar_rgb_pseudo_4123_real_210_oracle', osp.splitext(osp.basename(args.config))[0])
...
# python tools/train.py configs/daformer/rgb/france_japan_to_usa_daformer_mitb5.py 
