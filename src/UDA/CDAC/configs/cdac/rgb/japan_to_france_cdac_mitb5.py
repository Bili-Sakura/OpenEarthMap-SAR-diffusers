_base_ = [
    ...
    # USA->France Data Loading
    '../../_base_/datasets/rgb/japan_to_france.py',
...
uda = dict(
    ...
    imnet_feature_dist_lambda=0.0, #05,
...
checkpoint_config = dict(by_epoch=False, interval=800, max_keep_ckpts=1)
evaluation = dict(interval=800, metric='mIoU')
# Meta Information for Result Analysis
name = 'usa_to_france'
exp = 'basic'
name_dataset = 'OEM_SAR'
