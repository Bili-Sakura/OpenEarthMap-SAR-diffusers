...
def main(args):
    ...
    if args.work_dir is not None:
        ...
        cfg.work_dir = osp.join('./work_dirs/rgb_pseudo_4333', osp.splitext(osp.basename(args.config))[0])
...
# python tools/train.py configs/cdac/rgb/france_japan_to_usa_cdac_mitb5.py 